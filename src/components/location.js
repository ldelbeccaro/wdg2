    ...
    <div className='hotel-list'>
      <div className='section'>
        ...
        <div className='subsection'>
          ...
          <div className='notes'>We've run out of reduced rate rooms, but Terranea has offered our guests a 20% off promotion code for use when booking via www.terranea.com: DELBECNOSWED</div>
