    ...
    <div className='hotel-list'>
      <div className='section'>
        ...
        <div className='subsection'>
          <div className='notes'>All of our events will be hosted at Terranea :)</div>
          <div className='notes'>Our reduced rate is $425/night for an Ocean View room (normally $1100). Note that our rates extend 3 days before and 3 days after our event dates (7/22-24) if you'd like to come early or stay late!</div>
          ...
          <div className='instructions'>You must book by June 20, 2022 — we recommend booking as soon as possible to guarantee availability.</div>
          <div className='instructions'>Visit <a target="_blank" href="https://book.passkey.com/go/DelBeccaroNosratWedding">this link</a>, enter the dates you'd like to stay and click Search. Select the room type you're interested in, click Next twice to skip the two upgrade screens, and fill out the remaining information to book. Note you're not booked until you click "Confirm reservation" on the last screen.</div>
        </div>
      </div>
      <div className='section'>
        ...
        <div className='subsection'>
          ...
          <div className='notes'>There are more cost effective hotel options in Redondo Beach, Torrance, or San Pedro that are very close to our venue :)</div>
